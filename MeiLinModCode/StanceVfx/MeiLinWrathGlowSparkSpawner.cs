...
[GlobalClass]
public partial class MeiLinWrathGlowSparkSpawner : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        _texture = ResourceLoader.Load<Texture2D>("res://MeiLinMod/images/vfx/glow_spark.png", cacheMode: ResourceLoader.CacheMode.Ignore)!;
        if (_texture == null)
        {
            QueueFree();
            return;
    ...
    private void SpawnSpark(float initialAge)
    {
        ...
        sprite.Position = new Vector2(Mathf.Cos(angle) * dist, Mathf.Sin(angle) * dist);
