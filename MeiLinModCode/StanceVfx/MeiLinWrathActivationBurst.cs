...
[GlobalClass]
public partial class MeiLinWrathActivationBurst : Node2D
{
    ...
    public override void _Ready()
    {
        ...
        var texture = ResourceLoader.Load<Texture2D>("res://MeiLinMod/images/vfx/strike_line.png", cacheMode: ResourceLoader.CacheMode.Ignore);
        if (texture == null)
        {
            QueueFree();
            return;
