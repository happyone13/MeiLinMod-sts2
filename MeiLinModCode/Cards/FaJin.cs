...
public class FaJin() : MeiLinModCard(1, CardType.Attack, CardRarity.Uncommon, TargetType.Self)
{
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [new DynamicVar(ExtraHitsKey, 1m)];
    ...
    {
        DynamicVars[ExtraHitsKey].UpgradeValueBy(1m);
    }
}
