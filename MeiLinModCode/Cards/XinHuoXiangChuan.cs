...
public class XinHuoXiangChuan() : MeiLinModCard(0, CardType.Skill, CardRarity.Uncommon, TargetType.Self)
{
    private const string TriggersKey = "Triggers";

    protected override IEnumerable<DynamicVar> CanonicalVars => [new DynamicVar(TriggersKey, 2m)];
