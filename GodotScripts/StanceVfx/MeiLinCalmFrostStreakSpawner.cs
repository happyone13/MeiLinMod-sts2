...
[GlobalClass]
public partial class MeiLinCalmFrostStreakSpawner : Node2D
{
	...
	public override void _Ready()
	{
		...
		_texture = ResourceLoader.Load<Texture2D>("res://MeiLinMod/images/vfx/frost_streak.png", cacheMode: ResourceLoader.CacheMode.Ignore)!;
		if (_texture == null)
		{
			QueueFree();
			return;
